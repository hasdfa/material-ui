...
A selection of free application templates to help you get started building your app with Joy UI.
...
<example name="TemplateCollection">
```jsx file="TemplateCollection.js"
