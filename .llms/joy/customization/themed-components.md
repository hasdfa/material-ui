...
If you've used [Material UI](https://mui.com/material-ui/customization/theme-components/) before, you are probably familiar with this technique.
...
Note that by creating new colors, you're automatically opting out of the [global variant feature](https://mui.com/joy-ui/main-features/global-variants/), which gives you fine-grained control over CSS properties like `color`, `background`, and `border`.
...
Note that by creating new variants, you're automatically opting out of the [global variant feature](https://mui.com/joy-ui/main-features/global-variants/), which gives you fine-grained control over CSS properties like `color`, `background`, and `border`.
