...
Joy UI uses CSS variables to ensure that server-rendered apps can load in dark mode on first render.
...
See the [Applying dark mode](https://mui.com/joy-ui/customization/dark-mode/) page for more details on usage with other frameworks.