...
<example name="PaletteChanges">
```jsx file="PaletteChanges.js"
...
Follow the [installation guide](https://mui.com/joy-ui/getting-started/installation/#inter-font) to install it.
...
<example name="TitleBodyIconExample">
```tsx file="TitleBodyIconExample.tsx"
import * as React from 'react';
import Box from '@mui/joy/Box';
...
The [Tabs](https://mui.com/joy-ui/react-tabs/) component has been redesigned following feedback we've received on [this GitHub issue](https://github.com/mui/material-ui/issues/36782).
